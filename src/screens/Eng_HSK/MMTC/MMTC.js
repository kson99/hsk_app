  ...
  const onCardClick = (cardId, cardVal) => {
    ...
    // on second card click
      ...
      if (
        ...
        // Toast notification
        toast.success(levelChosen()[cardVal].pinyin, {
          position: "top-center",
          autoClose: 2000,
  ...
  return (
    <div className="MMTC">
      <header className="Header">
        ...
        <h1>Match Meaning To Character</h1>
        <p style={{ color: "crimson", fontSize: 25 }}>▶︎ Back</p>
      </header>
      <div className="MMTC-body">
        <div className="MMTC-Game">
