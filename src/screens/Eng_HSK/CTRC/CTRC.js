...
function CTRC(props) {
  ...
  const onAnswerClick = (val, id) => {
    if (val === "") {
      ...
      var show = document.querySelector(".CTRC-Pinyin");
  ...
  return (
    <div className="CTRC">
      ...
      <div className="CTRC-body">
        <div className="CTRC-Game">
          <div className="holder">
            <div className="CTRC-Levels">
          ...
          <div className="CTRC-Meaning">{tabSwitch()}</div>
          <div className="CTRC-Pinyin">{levelChosen()[randomNum].pinyin}</div>
          <div className="holder">
            <div className="CTRC-Char">
              {levelMeanings()}
          ...
          <div className="holder">
            <div className="CTRC-More">
              <div
                className="CTRC-Sound"
                onClick={() => {
