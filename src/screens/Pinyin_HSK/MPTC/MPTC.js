  ...
  const onCardClick = (cardId, cardVal) => {
    ...
    // on second card click
      ...
      if (
        ...
        // Toast notification
        toast.success(levelChosen()[cardVal].meaning, {
          position: "top-center",
          autoClose: 2000,
            ...
            {arrayShuffle(randomNum).map((val, index) => {
              return (
                <>
                  ...
                  >
                    {hskAllDict[randomNum[index]].pinyin}
                  </div>
                </>
              );
            })}
            ...
            {arrayShuffle(randomNum).map((val, index) => {
              return (
                <>
                  ...
                  >
                    {hsk1Dict[randomNum[index]].pinyin}
                  </div>
                </>
              );
            })}
            ...
            {arrayShuffle(randomNum).map((val, index) => {
              return (
                <>
                  ...
                  >
                    {hsk2Dict[randomNum[index]].pinyin}
                  </div>
                </>
              );
            })}
            ...
            {arrayShuffle(randomNum).map((val, index) => {
              return (
                <>
                  ...
                  >
                    {hsk3Dict[randomNum[index]].pinyin}
                  </div>
                </>
              );
            })}
            ...
            {arrayShuffle(randomNum).map((val, index) => {
              return (
                <>
                  ...
                  >
                    {hsk4Dict[randomNum[index]].pinyin}
                  </div>
                </>
              );
            })}
